        ...
        <div class="content playerControl">
            ...
            <div class="buttons">
                ...
                <button class="controlButton shuffle" title="Shuffle Button">
                        <img src="assets/images/shuffle_dark.png" alt="shuffle">
                </button>

                <button class="controlButton previous" title="Previous Button">
                        <img src="assets/images/rewind_dark.png" alt="Previous">
                </button>

                <button class="controlButton play" title="Play Button">
                        <img src="assets/images/play_dark.png" alt="Play">
                </button>

                <button class="controlButton pause" title="Pause Button" style="display: none;">
                        <img src="assets/images/pause_dark.png" alt="Pause">
                </button>

                <button class="controlButton next" title="Next Button">
                        <img src="assets/images/forward_dark.png" alt="Next">
                </button>
